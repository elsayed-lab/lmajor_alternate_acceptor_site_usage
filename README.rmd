...
for (name in genes$Name) {
    ...
    amastigote_utr5  = amastigote_sl[amastigote_sl$Name == name]
    ...
    amast_site    = find_primary_site(amastigote_utr5, 'sl', gene, gene_strand)
    ...
    if (gene_strand == '+') {
        ...
        # amastigote + strand
        amastigote_utr5_length = start(gene) - amast_site[1]
        ...
        # procyclic - strand
        amastigote_utr5_length = amast_site[1] - end(gene)
...
# amastigote
amastigote = data.frame(
    name=genes$Name,
    length=amastigote,
    num_reads=amastigote
)
...
for (name in genes$Name) {
    ...
    amastigote_utr3 = amastigote_polya[amastigote_polya$Name == name]
    ...
    amast_site    = find_primary_site(amastigote_utr3, 'polya', gene, gene_strand)
    ...
    if (gene_strand == '+') {
        ...
        # amastigote + strand
        amastigote_utr3_length = amast_site[1] - end(gene)
        ...
        # amastigote - strand
        amastigote_utr3_length = start(gene) - amast_site[1]
...
```{r alt_trans_splicing_meta_vs_pro, fig.width=3840/96, fig.height=2160/96}
# metacyclic vs. procyclic
...
utr5_comparison = data.frame(name=metacyclic_utr5_df$name,
                             metacyclic=metacyclic_utr5_df$length,
                             amastigote=amastigote_utr5_df$length,
                             count_difference=abs(metacyclic_utr5_df$num_reads -
                                                  amastigote_utr5_df$num_reads))
utr5_comparison %>% ggvis(~metacyclic, ~amastigote, fill=~count_difference) %>% 
    layer_points() %>% 
    add_tooltip(function(df) df$name)

ggplot(utr5_comparison, aes(metacyclic, amastigote, color=count_difference)) + 
    geom_point()

utr5_comparison_complete = utr5_comparison[complete.cases(utr5_comparison),]
utr5_diff = utr5_comparison_complete[utr5_comparison_complete$metacyclic != 
                                     utr5_comparison_complete$amastigote,]
utr5_diff$length_diff = abs(utr5_diff$metacyclic - utr5_diff$amastigote)
kable(head(utr5_diff[with(utr5_diff, order(length_diff, decreasing=TRUE)),], 50))
...
utr5_comparison = data.frame(name=procyclic_utr5_df$name,
                             procyclic=procyclic_utr5_df$length,
                             amastigote=amastigote_utr5_df$length,
                             count_difference=abs(procyclic_utr5_df$num_reads -
                                                  amastigote_utr5_df$num_reads))
utr5_comparison %>% ggvis(~procyclic, ~amastigote, fill=~count_difference) %>% 
    layer_points() %>% 
    add_tooltip(function(df) df$name)

ggplot(utr5_comparison, aes(procyclic, amastigote, color=count_difference)) + 
    geom_point()

utr5_comparison_complete = utr5_comparison[complete.cases(utr5_comparison),]
utr5_diff = utr5_comparison_complete[utr5_comparison_complete$procyclic != 
                                     utr5_comparison_complete$amastigote,]
utr5_diff$length_diff = abs(utr5_diff$procyclic - utr5_diff$amastigote)
kable(head(utr5_diff[with(utr5_diff, order(length_diff, decreasing=TRUE)),], 50))
...
```{r alt_polya_meta_vs_pro, fig.width=3840/96, fig.height=2160/96}
...
```{r alt_polya_meta_vs_amast, fig.width=3840/96, fig.height=2160/96}
utr3_comparison = data.frame(name=metacyclic_utr3_df$name,
                             metacyclic=metacyclic_utr3_df$length,
                             amastigote=amastigote_utr3_df$length,
                             count_difference=abs(metacyclic_utr3_df$num_reads -
                                                  amastigote_utr3_df$num_reads))
utr3_comparison %>% ggvis(~metacyclic, ~amastigote, fill=~count_difference) %>% 
    layer_points() %>% 
    add_tooltip(function(df) df$name)
ggplot(utr3_comparison, aes(metacyclic, amastigote, color=count_difference)) + 
    geom_point()

utr3_comparison_complete = utr3_comparison[complete.cases(utr3_comparison),]
utr3_diff = utr3_comparison_complete[utr3_comparison_complete$metacyclic != 
                                     utr3_comparison_complete$amastigote,]
utr3_diff$length_diff = abs(utr3_diff$metacyclic - utr3_diff$amastigote)
kable(head(utr3_diff[with(utr3_diff, order(length_diff, decreasing=TRUE)),], 50))
...
```{r alt_polya_pro_vs_amast, fig.width=3840/96, fig.height=2160/96}
utr3_comparison = data.frame(name=procyclic_utr3_df$name,
                             procyclic=procyclic_utr3_df$length,
                             amastigote=amastigote_utr3_df$length,
                             count_difference=abs(procyclic_utr3_df$num_reads -
                                                  amastigote_utr3_df$num_reads))
utr3_comparison %>% ggvis(~procyclic, ~amastigote, fill=~count_difference) %>% 
    layer_points() %>% 
    add_tooltip(function(df) df$name)
ggplot(utr3_comparison, aes(procyclic, amastigote, color=count_difference)) + 
    geom_point()

utr3_comparison_complete = utr3_comparison[complete.cases(utr3_comparison),]
utr3_diff = utr3_comparison_complete[utr3_comparison_complete$procyclic != 
                                     utr3_comparison_complete$amastigote,]
utr3_diff$length_diff = abs(utr3_diff$procyclic - utr3_diff$amastigote)
kable(head(utr3_diff[with(utr3_diff, order(length_diff, decreasing=TRUE)),], 50))
